<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="flex items-center flex-shrink-0">
                    <a href="{{ route('dashboard') }}">
                        ...
                        <img class="m-auto"   id="sigma" style="width:7em " src="{{asset("/image/sigma.png")}}">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('inscripcion') }}" :active="request()->routeIs('inscripcion')">
                      {{ __('Inscripción') }}
                  </x-jet-nav-link>
                  ...
                  <div class="relative flex items-center flex-shrink-0 ml-3">
                    <x-jet-dropdown align="left" width="60">
                        <x-slot name="trigger">
                            <span class="inline-flex rounded-md">
                                <button type="button" class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out bg-white border border-transparent rounded-md hover:bg-gray-50 hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50">
                                    Estudiantes <i class="ml-3 fas fa-sort-down"></i>
                                </button>
                            </span>
                        ...
                        <x-slot name="content">
                            <div class="w-60">
                                ...
                                <x-jet-dropdown-link href="{{ route('inscripcion') }}" :active="request()->routeIs('estudiantes')">
                                    {{ __('Estudiantes') }}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('users')">
                {{ __('Usuarios') }}
            </x-jet-responsive-nav-link>

            <x-jet-responsive-nav-link href="{{ route('inscripcion') }}" :active="request()->routeIs('inscripcion')">
              {{ __('Inscripción') }}
          </x-jet-responsive-nav-link>
